...
// This function defines placement of rectangles for each parent/child
...
/* shows treemap and writes the emebed transition fun */
...
// write parent rectangle
     g.append("rect")
         .attr("class", "parent")
         .call(rect); // call the rectange function to assign dimensions to the rectange
...
// add text for the child nodes
    ...
    //remove the old node when transition is finished
